...
class DQNCartPoleSolver():
    ...
    def run(self):
        ...
        for e in range(self.n_episodes):
            ...
            ALPHA = 1e-3
            prev_y2 = np.zeros(shape=(1, LAYER2))
            ...
            while not done:
                ...
                ################
                grad = lr * elig1
                self.weights1 = np.clip(self.weights1 + grad, 0.001, 10.0)
                
                grad = lr * elig2

                self.weights2 = np.clip(self.weights2 + grad, 0.001, 10.0)
                ...
                # B
                dw = (ALPHA * (reward + y3 - prev_y3) * elig3)
                ...
                self.weights3 = np.clip(self.weights3 + dw, 0.001, 10.0)
