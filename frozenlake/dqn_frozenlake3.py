...
class DQNCartPoleSolver():
    def __init__(self, n_episodes=10000, max_env_steps=None, gamma=1.0, epsilon=0.5, epsilon_min=0.01, epsilon_decay=0.99, alpha=0.1, alpha_decay=0.01, batch_size=32, quiet=False):
        ...
        # self.model.add(Dense(32, input_dim=16, activation='linear'))
        # self.model.add(Dense(4, activation='linear'))

        self.model.add(Dense(4, input_dim=64, activation='linear'))
