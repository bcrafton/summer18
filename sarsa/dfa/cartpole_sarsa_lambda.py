...
class SarsaCartpole():
    def __init__(self):
        ...
        b1 = np.random.uniform(0.0, 1.0, size=(LAYER1, LAYER3)) * 2 * EPSILON
        b2 = np.random.uniform(0.0, 1.0, size=(LAYER2, LAYER3)) * 2 * EPSILON
                        
        self.model = nn_sarsa_dfa(size=[LAYER1, LAYER2, LAYER3], \
