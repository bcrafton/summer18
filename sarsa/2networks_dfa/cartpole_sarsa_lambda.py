...
from nn_sarsa_dfa import nn_sarsa_dfa
...
class SarsaCartpole():
    def __init__(self):
        ...
        left_b1 = np.random.uniform(0.0, 1.0, size=(LAYER1, LAYER3)) * 2 * EPSILON
        left_b2 = np.random.uniform(0.0, 1.0, size=(LAYER2, LAYER3)) * 2 * EPSILON
        
        right_b1 = np.random.uniform(0.0, 1.0, size=(LAYER1, LAYER3)) * 2 * EPSILON
        right_b2 = np.random.uniform(0.0, 1.0, size=(LAYER2, LAYER3)) * 2 * EPSILON

        self.left = nn_sarsa_dfa(size=[LAYER1, LAYER2, LAYER3],   \
        ...
        self.right = nn_sarsa_dfa(size=[LAYER1, LAYER2, LAYER3],  \
