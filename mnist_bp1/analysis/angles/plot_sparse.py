...
for ii in range(250):
    ...
    W2_ii_0 = np.load("../sparse_dfa/W2_" + str(ii+1) + "_0.npy")
    W2_ii_0 = W2_ii_0[0:25]
    W2_ii_0 = np.reshape(W2_ii_0, (-1, 1))
    
    W2_ii_1 = np.load("../sparse_dfa/W2_" + str(ii+1) + "_1.npy")
    W2_ii_1 = W2_ii_1[0:25]
    W2_ii_1 = np.reshape(W2_ii_1, (-1, 1))
    
    W2_ii_2 = np.load("../sparse_dfa/W2_" + str(ii+1) + "_2.npy")
    W2_ii_2 = W2_ii_2[0:25]
    W2_ii_2 = np.reshape(W2_ii_2, (-1, 1))
    
    W2_ii_3 = np.load("../sparse_dfa/W2_" + str(ii+1) + "_3.npy")
...
for ii in range(250):  
    ...
    W2_ii_0 = np.load("../bad_sparse_dfa/BAD_W2_" + str(ii+1) + "_0.npy")
    W2_ii_0 = W2_ii_0[0:25]
    W2_ii_0 = np.reshape(W2_ii_0, (-1, 1))
    
    W2_ii_1 = np.load("../bad_sparse_dfa/BAD_W2_" + str(ii+1) + "_1.npy")
    W2_ii_1 = W2_ii_1[0:25]
    W2_ii_1 = np.reshape(W2_ii_1, (-1, 1))
    
    W2_ii_2 = np.load("../bad_sparse_dfa/BAD_W2_" + str(ii+1) + "_2.npy")
    W2_ii_2 = W2_ii_2[0:25]
    W2_ii_2 = np.reshape(W2_ii_2, (-1, 1))
    
    W2_ii_3 = np.load("../bad_sparse_dfa/BAD_W2_" + str(ii+1) + "_3.npy")
    W2_ii_3 = W2_ii_3[0:25]
    W2_ii_3 = np.reshape(W2_ii_3, (-1, 1))
