...
high = 1.0 / np.sqrt(np.sqrt(101))
low = -high
tmp1 = np.random.uniform(low=low, high=high, size=(101, 10))
tmp2 = np.random.uniform(low=low, high=high, size=(101, 10))
B = tmp1 * tmp2
B = B - np.average(B)
np.save("B", B)
...
high = 1.0 / np.sqrt(np.sqrt(101))
low = -high
tmp1 = np.random.uniform(low=low, high=high, size=(101, 1))
