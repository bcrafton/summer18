...
##############################################
W1 = tf.Variable(tf.random_uniform(shape=[784, 25]) * (2 * 0.12) - 0.12)
W2 = tf.Variable(tf.random_uniform(shape=[25, 10]) * (2 * 0.12) - 0.12)
##############################################
# FEED FORWARD
##############################################
...
G1 = tf.matmul(tf.transpose(A1), D2)
...
prev1 = np.zeros(shape=(784, 25))
prev2 = np.zeros(shape=(25, 10))
