...
class Solver():
    def __init__(self, n_episodes=1000, max_env_steps=None, gamma=1.0, epsilon=0.5, epsilon_min=0.01, epsilon_decay=0.99, alpha=0.10, alpha_decay=0.04, batch_size=32, quiet=False):
        ...
        init_weights = [np.ones(shape=(16, 4)) * 500.0, np.zeros(shape=(4))]
