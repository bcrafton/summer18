...
neurons = NeuronGroup(10*10, eqs_neurons, threshold='v>vt', reset='v = vr', method='exact')
output = NeuronGroup(4*4, eqs_neurons, threshold='v>vt', reset='v = vr', method='exact')
...
mon0 = StateMonitor(S0, 'w', record=range(10*10))
...
mon1 = StateMonitor(S1, 'w', record=range(4*4))
spike_mon2 = SpikeMonitor(output)
...
spike_plot_x2, spike_plot_y2 = spike_plot(spike_mon2)
...
subplot(515)
plot(spike_plot_x2, spike_plot_y2, '.k')
