...
end_time_training = 100

start_time_testing = 0
end_time_testing = 100
...
print 'load results'
training_result_monitor = np.load('../activity/resultPopVecs100.npy')
training_input_numbers = np.load('../activity/inputNumbers100.npy')

testing_result_monitor = np.load('../activity/resultPopVecs100.npy')
testing_input_numbers = np.load('../activity/inputNumbers100.npy')

print 'get assignments'
test_results = np.zeros((10, 100))
test_results_max = np.zeros((10, 100))
test_results_top = np.zeros((10, 100))
test_results_fixed = np.zeros((10, 100))
assignments = get_new_assignments(training_result_monitor[0:100], training_input_numbers[0:100])
print assignments
...
difference = test_results[0, :] - testing_input_numbers[0:100]
