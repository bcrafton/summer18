...
if args.train:
    ...
    np.save('./results/assign_spks_10000',   spk_count[0:num_assign])
    np.save('./results/assign_labels_10000', labels[0:num_assign])
    np.save('./results/test_spks_10000',     spk_count[num_assign:num_assign+num_test])
    np.save('./results/test_labels_10000',   labels[num_assign:num_assign+num_test])
#############
