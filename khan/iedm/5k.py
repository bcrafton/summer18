...
if args.train:
    ...
    w = np.load('./5k/XeAe_trained_5000.npy')
    theta = np.load('./5k/theta_trained_5000.npy')
...
if args.train:
    ...
    np.save('./results/assign_spks_5000',   spk_count[0:num_assign])
    np.save('./results/assign_labels_5000', labels[0:num_assign])
    np.save('./results/test_spks_5000',     spk_count[num_assign:num_assign+num_test])
    np.save('./results/test_labels_5000',   labels[num_assign:num_assign+num_test])
#############
