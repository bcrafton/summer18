...
if args.train:
    ...
    w = np.load('./150k/XeAe_trained.npy')
    theta = np.load('./150k/theta_trained.npy')
...
if args.train:
    ...
    np.save('./results/assign_spks_150000',   spk_count[0:num_assign])
    np.save('./results/assign_labels_150000', labels[0:num_assign])
    np.save('./results/test_spks_150000',     spk_count[num_assign:num_assign+num_test])
    np.save('./results/test_labels_150000',   labels[num_assign:num_assign+num_test])
#############
