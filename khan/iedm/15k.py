...
if args.train:
    ...
    w = np.load('./15k/XeAe_trained_15000.npy')
    theta = np.load('./15k/theta_trained_15000.npy')
...
if args.train:
    ...
    np.save('./results/assign_spks_15000',   spk_count[0:num_assign])
    np.save('./results/assign_labels_15000', labels[0:num_assign])
    np.save('./results/test_spks_15000',     spk_count[num_assign:num_assign+num_test])
    np.save('./results/test_labels_15000',   labels[num_assign:num_assign+num_test])
#############
