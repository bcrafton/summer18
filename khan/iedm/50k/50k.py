...
if args.train:
    ...
    np.save('./results/assign_spks_50k',   spk_count[0:num_assign])
    np.save('./results/assign_labels_50k', labels[0:num_assign])
    np.save('./results/test_spks_50k',     spk_count[num_assign:num_assign+num_test])
    np.save('./results/test_labels_50k',   labels[num_assign:num_assign+num_test])
#############
