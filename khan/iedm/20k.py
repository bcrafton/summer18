...
if args.train:
    ...
    w = np.load('./20k/XeAe_trained_20000.npy')
    theta = np.load('./20k/theta_trained_20000.npy')
...
if args.train:
    ...
    np.save('./results/assign_spks_20000',   spk_count[0:num_assign])
    np.save('./results/assign_labels_20000', labels[0:num_assign])
    np.save('./results/test_spks_20000',     spk_count[num_assign:num_assign+num_test])
    np.save('./results/test_labels_20000',   labels[num_assign:num_assign+num_test])
#############
