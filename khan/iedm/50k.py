...
if args.train:
    ...
    w = np.load('./50k/XeAe_trained.npy')
    theta = np.load('./50k/theta_trained.npy')
...
if args.train:
    ...
    np.save('./results/assign_spks_50000',   spk_count[0:num_assign])
    np.save('./results/assign_labels_50000', labels[0:num_assign])
    np.save('./results/test_spks_50000',     spk_count[num_assign:num_assign+num_test])
    np.save('./results/test_labels_50000',   labels[num_assign:num_assign+num_test])
#############
