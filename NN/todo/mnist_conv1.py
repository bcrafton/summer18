...
l0 = Convolution(input_sizes=[batch_size, 28, 28, 1], filter_sizes=[3, 3, 1, 32], num_classes=10, init_filters=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=ALPHA, activation=Relu(), last_layer=False, sparse=sparse)
l1 = MaxPool(size=[batch_size, 28, 28, 32], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")
l2 = Feedback(size=[batch_size, 14, 14, 32], num_classes=10, sparse=sparse)

l3 = Convolution(input_sizes=[batch_size, 14, 14, 32], filter_sizes=[3, 3, 32, 32], num_classes=10, init_filters=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=ALPHA, activation=Relu(), last_layer=False, sparse=sparse)
l4 = MaxPool(size=[batch_size, 14, 14, 32], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")
l5 = Feedback(size=[batch_size, 7, 7, 32], num_classes=10, sparse=sparse)

l6 = Convolution(input_sizes=[batch_size, 7, 7, 32], filter_sizes=[3, 3, 32, 32], num_classes=10, init_filters=args.init, strides=[1, 1, 1, 1], padding="SAME", alpha=ALPHA, activation=Relu(), last_layer=False, sparse=sparse)
l7 = MaxPool(size=[batch_size, 7, 7, 32], ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")
l8 = Feedback(size=[batch_size, 4, 4, 32], num_classes=10, sparse=sparse)

l9 = ConvToFullyConnected(shape=[4, 4, 32])
l10 = FullyConnected(size=[4*4*32, 128], num_classes=10, init_weights=args.init, alpha=ALPHA, activation=Relu(), last_layer=False, sparse=sparse)

l11 = FullyConnected(size=[128, 10], num_classes=10, init_weights=args.init, alpha=ALPHA, activation=Linear(), last_layer=True, sparse=sparse)
